    ...
    <footer class="sticky bottom-0 text-gray-600 body-font z-50 bg-amber-100">
      <div class="container px-3 py-6 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        <div class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center ">
          <Link href="/" className="flex title-font font-sm items-center text-gray-400  hover:text-gray-900 mb-4 mr-3 md:mb-0 hover:opacity-70 transition duration-300 ease-in-out">
          ...
          <Link href="/references" className="flex title-font font-sm items-center text-gray-400  hover:text-gray-900 mb-4 mr-3 md:mb-0 hover:opacity-70 transition duration-300 ease-in-out">
          <Image alt="dish" src={dish} width="20" height="20" />
              <h1 className="ml-2">Dish </h1>
            
         
          </Link>
          <Link href="/faq" className="flex title-font font-sm items-center text-gray-400  hover:text-gray-900 mb-4 mr-3 md:mb-0 hover:opacity-70 transition duration-300 ease-in-out " >
          <Image alt="info" src={faq} width="20" height="20" />
              <h1 className="ml-2">Review  </h1>
            
         
          </Link>
          <Link href="/about" className="flex title-font font-sm items-center text-gray-400  hover:text-gray-900 mb-4 mr-3 md:mb-0 hover:opacity-70 transition duration-300 ease-in-out">
