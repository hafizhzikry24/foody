      ...
      <section className="text-gray-600 body-font">
            <div className="container px-5 py-52 mx-auto">
                <div className="text-center mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Food  References</h1>
                    <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Here are some data references that we use to serve you our delicious menus!</p>
                </div>
